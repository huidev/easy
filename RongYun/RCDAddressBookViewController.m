...
-(void) getAllData
{
    RCDHttpTool *httpTool = [RCDHttpTool shareInstance];
    [httpTool getFriends:^(NSMutableArray *result) {
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(user){
        cell.lblName.text = user.f_user_remark_name;
        [cell.imgvAva setImageWithURL:[NSURL URLWithString:user.f_ico] placeholderImage:IMAGE_HOLD];
...
-(NSMutableDictionary *) sortedArrayWithPinYinDic:(NSArray *) friends
{
    ...
    for (NSString *key in _keys) {
        ...
        for (RCDUserInfo *user in friends) {
            ...
            NSString *pyResult = [self hanZiToPinYinWithString:user.f_user_remark_name];
