...
@interface DoImagePickerController : UIViewController<DoImagePickerControllerDelegate1>
...
@property (strong, nonatomic) NSMutableArray *selectedKeys;
...
- (void)didSelectPhotosFromDoImagePickerController:(DoImagePickerController *)picker result:(NSArray *)aSelected :(NSDictionary *)hasSelectedDic;
