...
- (void)setUpPopup {
    ...
    if (self.contents) {
        for (NSObject *content in self.contents) {
            if ([content isKindOfClass:[NSAttributedString class]]) {
                ...
                UIImageView *imageView = [self centeredImageViewForImage:(NSString *)content];
                [imageView sizeToFit];
            ...
            {
                NSString *imageStr = [(NSDictionary *)content objectForKey:@"titleImage"];
                NSString *titleStr =[(NSDictionary *)content objectForKey:@"titleText"];
                UIImageView *imageView;
                if (imageStr) {
                    imageView = [self centeredImageViewForImage:imageStr];
                    [imageView sizeToFit];
                ...
                if (titleStr) {
                    UILabel *label = [self multilineLabelWithAttributedString:(NSAttributedString *)titleStr];
                    [self.contentView addSubview:label];
                    label.tag =101;
    ...
    [self.contentView.subviews enumerateObjectsUsingBlock:^(UIView *view, NSUInteger idx, BOOL *stop) {
        if (idx == 0) {
            [self.contentView addConstraint:[NSLayoutConstraint constraintWithItem:view attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.contentView attribute:NSLayoutAttributeTop multiplier:1.0 constant:self.theme.popupContentInsets.top-6]];
            [self.contentView addConstraint:[NSLayoutConstraint constraintWithItem:view attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self.contentView attribute:NSLayoutAttributeLeft multiplier:1.0 constant:self.theme.popupContentInsets.top-6]];
        }else if (idx==1 &&view.tag==101)
        {
            UIView *previousSubView = [self.contentView.subviews objectAtIndex:idx - 1];
            [self.contentView addConstraint:[NSLayoutConstraint constraintWithItem:view attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:previousSubView attribute:NSLayoutAttributeCenterY multiplier:1.0 constant:0]];
            [self.contentView addConstraint:[NSLayoutConstraint constraintWithItem:view attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:previousSubView attribute:NSLayoutAttributeRight multiplier:1.0 constant:10]];
        }
        else {
            UIView *previousSubView = [self.contentView.subviews objectAtIndex:idx - 1];
            ...
            if (view.tag==100) {
                ...
                [self.contentView addConstraint:[NSLayoutConstraint constraintWithItem:view attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self.contentView attribute:NSLayoutAttributeLeft multiplier:1.0 constant:self.theme.popupContentInsets.top]];
                [self.contentView addConstraint:[NSLayoutConstraint constraintWithItem:view attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationLessThanOrEqual toItem:view attribute:NSLayoutAttributeWidth multiplier:1.0 constant:0]];
            ...
            }else
            {
                ...
                [self.contentView addConstraint:[NSLayoutConstraint constraintWithItem:view attribute:NSLayoutAttributeLeft relatedBy:NSLayoutRelationEqual toItem:self.contentView attribute:NSLayoutAttributeLeft multiplier:1.0 constant:self.theme.popupContentInsets.left+self.leftSpace]];
...
- (UIImageView *)centeredImageViewForImage:(NSString *)image {
    UIImageView *imageView = [[UIImageView alloc]init];;
    if ([StrUtils checkHttpAddress:image]) {
